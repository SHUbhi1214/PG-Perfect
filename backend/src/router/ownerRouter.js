...
import  { cheakDepositStatus, checkPaymentStatus,createDeposit,createPayment, getRevenueData } from "../controller/testController.js"
...
ownerRouter.route("/verify").post(varifySubscribtion)
ownerRouter.route("/getAllSubscription").get(jwtAuth,getAllSubscription)
